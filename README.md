...
Designing tables to hold the data from given CSV files, import the CSV files into a SQL database, and then answer questions about the data. Process is done through performing data modeling, data engineering, and data analysis, respectively.
